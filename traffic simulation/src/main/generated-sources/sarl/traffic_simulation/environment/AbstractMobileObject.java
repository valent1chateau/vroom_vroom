...
import traffic_simulation.environment.AbstractSituatedObject;
import traffic_simulation.environment.MobileObject;
...
public abstract class AbstractMobileObject extends AbstractSituatedObject implements MobileObject {
  ...
  public AbstractMobileObject clone() {
    try {
      return (AbstractMobileObject) super.clone();
